set psfname /project2/roux/scguo/ci-vsd/civsd-pro
set dirxtc /project2/roux/scguo/ci-vsd/biased/smd-prep

# skip first frame since it contains reference pdb
set firstframe 2 
set skipframe 1
...
# set outfile /project2/roux/scguo/ci-vsd/suppl-runs/${xtcname}.txt

mol load psf $psfname.psf pdb $psfname.pdb
mol addfile $dirxtc/$xtcname waitfor all
